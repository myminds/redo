...
export async function generateMetadata(): Promise<Metadata> {
  const posts = getPostsByCategory("job");
  
  return {
    title: "Job & Career Blog - Readindo.com",
...
export default function JobBlog() {
  const blogPosts = getPostsByCategory("job");
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        ...
        <nav className="py-4 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <span>/</span>
            <span className="text-gray-900 dark:text-white font-medium">Job</span>
          </div>
        </nav>
