...
export const metadata: Metadata = {
  ...
  description: "Learn about RedoHelp - your trusted source for technology, finance, business, career, and automobile content. Discover our mission and values.",
          ...
          <div className="prose prose-lg prose-gray dark:prose-invert max-w-none">
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                At RedoHelp, we believe that knowledge is the key to success. Our mission is to provide high-quality, 
