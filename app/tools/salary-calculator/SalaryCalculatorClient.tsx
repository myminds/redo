...
// Indian Income Tax Slabs for FY 2024-25 - Moved outside component to prevent recreation
...
export default function SalaryCalculator() {
  ...
  }, [ctc, basicPercentage, hraPercentage, daPercentage, pfPercentage, esiPercentage, professionalTax, mounted]);
  ...
  return (
    <div suppressHydrationWarning className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-100 dark:from-gray-900 dark:to-gray-800 py-8">
